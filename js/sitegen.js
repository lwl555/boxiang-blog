// ===== 免费建站 · 网站模板生成器（前台/后台共用） =====
window.BXSiteGen = (function () {
...
<section class="sec" id="contact">
  ...
  <div class="cta">
    <div class="box">
      <h2>找到我</h2>
      <p>${esc(d.contact)}</p>
      <a class="btn" href="${BASE}/#order">向薄想工作室下单</a>
    </div>
  </div>
</section>

<footer>
  ${esc(d.title)} · 由 <a href="${BASE}" target="_blank">薄想工作室</a> 免费生成
</footer>
</body>
</html>`;
  }
  return { generateSiteHtml: generateSiteHtml, esc: esc, THEMES: THEMES };
})();