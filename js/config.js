// Supabase 配置（anon key 公开可见，数据由 RLS 保护）
...
window.SUPABASE_TABLES = { orders: 'orders', posts: 'posts', config: 'site_config', sites: 'sites', site_data: 'site_data', site_backend: 'site_backend' };